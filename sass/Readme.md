...
folder are mapped to the application's root namespace, 'Thesis.Manager'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Thesis.Manager' in the same way
as `"Thesis.Manager/sass/src"`.
